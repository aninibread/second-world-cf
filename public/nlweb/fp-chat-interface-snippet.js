...
class ModernChatInterface {
  ...
  getStreamingResponse(query) {
    ...
    console.log('API Endpoint from config:', this.apiEndpoint);
    const baseUrl = this.apiEndpoint || (window.location.origin === 'file://' ? 'http://localhost:8000' : window.location.origin);
